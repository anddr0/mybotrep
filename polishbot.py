...
def new_command(message):
    lines = open('D:\\3.14ton\\prjcts\\Polish_words.txt', encoding='utf-8').read().splitlines()
...
def start_message(message):
    lines1 = open('D:\\3.14ton\\prjcts\\Polish_words.txt', encoding='utf-8').read().splitlines()
